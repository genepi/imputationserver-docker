...
```
 docker run -d -p 8080:80 genepi/imputationserver:v1.2.1
```
...
```
docker run -d -p 8080:80  -v /home/lukas/imputationserver-data/:/data/ genepi/imputationserver:v1.2.1
```
...
```
docker run -d -p 8080:80  -v /home/lukas/imputationserver-data/:/data/ genepi/imputationserver:vv1.2.1
```
